...
const pieceDb = require("../db/utilisateurs/utilisateursDb");
const db = require("../db/utilisateurs/utilisateursDb").getDb();
...
console.log('http://localhost:' + port + '/api/utilisateurs');
